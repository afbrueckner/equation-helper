...
function checkPracticeStep1() {
    console.log("checkPracticeStep1 called");
...
function checkPracticeStep2() {
    console.log("checkPracticeStep2 called");
...
function goToChallenge() {
    console.log("goToChallenge called");
...
function checkChallengeStep1() {
    console.log("checkChallengeStep1 called");
...
function checkChallengeStep2() {
    console.log("checkChallengeStep2 called");
